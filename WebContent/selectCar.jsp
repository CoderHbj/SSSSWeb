    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <form class="navbar-form navbar-right" action="SelectCar" method="post">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="SelectAllCar">车辆管理<!--<span class="sr-only">(current)</span>--></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <table class="table table-hover piece" style="margin-left: 0;">
					<thead>
						<tr>
							<th width="50px"><input id="all" type="checkbox"
								class="head">全选</th>
							<th>车辆编码</th>
							<th>中文名</th>
							<th>英文名</th>
						...
						<s:iterator value="carlist" var="u">
							<tr>
								...
								<td><a href="javascript:void(0);" class="btn btn-warning"
									rel="${id}" role="button" /><span
									class="glyphicon glyphicon-cog" aria-hidden="true"></span>修改</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
          	<s:url id="url_pre" value="SelectCar">  
         		<s:param name="pageNow" value="pageNow-1"></s:param>  
     		</s:url>  
  
     		<s:url id="url_next" value="SelectCar">  
         		<s:param name="pageNow" value="pageNow+1"></s:param>  
     		</s:url>    
