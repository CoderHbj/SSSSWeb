		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
						...
						<s:iterator value="list">
							<tr>
								...
								<td><a href="javascript:void(0);" class="btn btn-warning"
									rel="${userid}" role="button" /><span
									class="glyphicon glyphicon-cog" aria-hidden="true"></span>修改资料</a></td>
								<td><a href="deleteUser?userid=${userid}"
									class="btn btn-danger" role="button" /><span
									class="glyphicon glyphicon-trash" aria-hidden="true"></span>删除用户</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
				...
				<s:bean name="org.apache.struts2.util.Counter" id="counter">
					...
					<s:iterator>
						<a href="selectAllUser?pageNow=<s:property/>"
							class="btn btn-primary btn-lg" role="button"><s:property /></a>
					</s:iterator>
				</s:bean>
			...
			<div class="modal-content">
				...
				<form action="addUser" method="post" id="addForm">
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="phonenum">手机号码</label> <input type="text"
								class="form-control" id="phonenum" name="phonenum"
								placeholder="手机号码">
						</div>
						<div class="form-group">
							<label for="post">职位</label> <select class="form-control"
								name="post">
								<s:iterator value="postlist">
									<option value="${post}"><s:property value="post" />||
										<s:property value="task" /></option>
								</s:iterator>
							</select>
						</div>
						<div class="radio">
