...
%>
		...
		<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false"> 价格<span class="caret"></span>
		</a>
		<ul class="dropdown-menu" role="menu">
		<li role="presentation"><a
		href="sGoodsA?chn_name<s:property value="chn_name"/>&remark=1 ">从高到低</a></li>
		<li role="presentation"><a
		href="sGoodsA?chn_name<s:property value="chn_name"/>&remark=2 ">从低到高</a></li>
		</ul>
		</li>
		<li role="presentation" class="dropdown">
		<a class="dropdown-toggle" data-toggle="dropdown" href="#"
		role="button" aria-expanded="false"> 销量<span class="caret"></span>
		</a>
		<ul class="dropdown-menu" role="menu">
		<li role="presentation"><a
		href="sGoodsA?chn_name=<s:property value="chn_name"/>&remark=3 ">从高到低</a></li>
		<li role="presentation"><a
		href="sGoodsA?chn_name=<s:property value="chn_name"/>&remark=4 ">从低到高</a></li>
		</ul></li>
		<li role="presentation" style="float:right; line-height:40px;">
		<b>搜索条件：
		<s:if test="remark==0">无</s:if>
		<s:if test="remark==1">价格从高到低</s:if>
		<s:if test="remark==2">价格从低到高</s:if>
		<s:if test="remark==3">销量从高到低</s:if>
		<s:if test="remark==4">销量从低到高</s:if>
		</b>
		</li>
		</ul>
		...
		<s:iterator value="list" var="u">
			<div class="Goods">
			<a href="sDetialGoodsA?id=<s:property value="#u.id"/>"> <img
			class="detialImg" src="<s:property value="#u.img"/>" /></a>
			<div class="clear">
			<p class="money">
			&nbsp;¥
